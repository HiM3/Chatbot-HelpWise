  ...
  return (
    ...
    >
      <div className="bg-white p-8 rounded-lg shadow-xl w-full max-w-md text-center transition-colors duration-300 dark:bg-[#2d334a] dark:text-[#f4f4f4] dark:shadow-xl">
        <h2 className="mb-6 text-3xl font-semibold text-[#333] transition-colors duration-300 dark:text-[#f4f4f4]">Sign Up</h2>
        <form onSubmit={handleSubmit} className="text-left">
          <div className="mb-5">
            <label htmlFor="username" className="block mb-2 font-semibold text-[#555] transition-colors duration-300 dark:text-[#d0d3d8]">Username:</label>
            <input
              type="text"
              id="username"
              value={username}
          ...
          <div className="mb-5">
            <label htmlFor="confirmPassword" className="block mb-2 font-semibold text-[#555] transition-colors duration-300 dark:text-[#d0d3d8]">Confirm Password:</label>
            <input
              type="password"
              id="confirmPassword"
        ...
        <p className="mt-4 text-sm text-center">
          Already have an account? <Link to="/login" className="text-[#4e7cff] hover:underline">Login</Link>
        </p>
      </div>
    </motion.div>
  );
